import"./mustache.c5531e42.js";import{b as h}from"./init.ed0bf5f4.js";WA.onInit(async()=>{await h().then(()=>{console.log("Scripting API Extra ready")}).catch(n=>console.error(n));var a=void 0,o=!1,r="https://db-planet.deutschebahn.com/pages/telefonie/apps/content/workadventure-erste-schritte";function e(){a!==void 0&&(a.close(),a=void 0)}var l="evs-info",p="intro",u="tutorial",s="tutorial1",c="tutorial2",d="guide",W="guide1",b="guide2",m="pong",v="mailto:DB.Systel.CommunicationServices.EVS@deutschebahn.com",A="Du hast eine Frage zu WorkAdventure, aber wir sind gerade nicht da? Schreib uns!",f=`Willkommen bei unserer WorkAdventure Worldtour!
